...
stats_payload = {
    ...
    'thresholds': {'p05': 935, 'p15': 830, 'p25': 750, 'dc': 800, 'x2': 780},
    'rows': stats_rows,
}
...
# Kısıtlı veri hariç; her pazar kendi eşiğiyle (0.5≥%93,5, 1.5≥%83, 2.5≥%75, 1X/12≥%80, X2≥%78).
HL_MARKETS = [
    ('0.5+', 6, 935, lambda hg, ag: hg + ag >= 1),
