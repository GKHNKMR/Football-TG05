...
(function (root) {
  ...
  add({
    ...
    'std.cols': { tr: '#,Takım,O,G,B,M,A,Y,AV,P', en: '#,Team,P,W,D,L,GF,GA,GD,Pts', nl: '#,Team,Wd,W,G,V,DV,DT,DS,P' },
    ...
    'cs.need': { tr: 'Günlük hedef {g} · kupona kasanın {f} · gereken oran <b>{r}</b> · Fikstür\'de vurgulanan tahminlerden, en fazla {max} maç, tutma olasılığı en yüksek kombinasyon', en: 'Daily target {g} · coupon stake {f} of bankroll · required odds <b>{r}</b> · from the highlighted picks in Fixtures, at most {max} matches, the combination most likely to win', nl: 'Dagdoel {g} · inzet {f} van de bankroll · benodigde odds <b>{r}</b> · uit de gemarkeerde voorspellingen, maximaal {max} wedstrijden, de combinatie met de grootste kans' },
    'Tahmini kupon oranı': { en: 'Estimated coupon odds', nl: 'Geschatte couponodds' },
    '(geçmiş piyasa ortalaması)': { en: '(past market average)', nl: '(historisch marktgemiddelde)' },
    'Kupona yatacak': { en: 'Stake', nl: 'Inzet' },
    'Bu gün en fazla 5 vurgulu maçla gereken orana ulaşılamıyor.': { en: 'On this day the required odds cannot be reached with at most 5 highlighted matches.', nl: 'Op deze dag zijn de benodigde odds niet haalbaar met maximaal 5 gemarkeerde wedstrijden.' },
    'Gerçekçi beklenti': { en: 'Realistic outlook', nl: 'Realistisch vooruitzicht' },
    'ortanca {d} gün': { en: 'median {d} days', nl: 'mediaan {d} dagen' },
    'cs.proj': { tr: 'Bu kuralın geçmişteki gerçek kuponlarıyla 2.000 kez 1 yıl oynatıldı: {bank} → {goal} hedefine <b>1 yıl içinde ulaşma ihtimali {p}</b> ({med}); <b>kasanın erime ihtimali {bust}</b>. Teorik hedef çizgisi {site} gün diyor.', en: 'Played 2,000 times for 1 year with this rule\'s real past coupons: <b>chance to reach {goal} from {bank} within a year: {p}</b> ({med}); <b>chance the bankroll melts: {bust}</b>. The theoretical target line says {site} days.', nl: '2.000 keer een jaar gespeeld met de echte historische coupons van deze regel: <b>kans om binnen een jaar van {bank} naar {goal} te gaan: {p}</b> ({med}); <b>kans dat de bankroll smelt: {bust}</b>. De theoretische doellijn zegt {site} dagen.' },
    'cs.projm': { tr: 'Geçmişte bu kural: {n} kupon, {w} tuttu, ort. oran {o}, ort. {l} maç; ortalama {per} günde bir kupon çıkıyor.', en: 'This rule in the past: {n} coupons, {w} won, avg. odds {o}, avg. {l} matches; about one coupon every {per} days.', nl: 'Deze regel in het verleden: {n} coupons, {w} gewonnen, gem. odds {o}, gem. {l} wedstrijden; ongeveer één coupon per {per} dagen.' },
    'Maçta en az 1 gol': { en: 'At least 1 goal in the match', nl: 'Minstens 1 doelpunt in de wedstrijd' },
    'Maçta en az 2 gol': { en: 'At least 2 goals in the match', nl: 'Minstens 2 doelpunten in de wedstrijd' },
    'Maçta en az 3 gol': { en: 'At least 3 goals in the match', nl: 'Minstens 3 doelpunten in de wedstrijd' },
    'oran': { en: 'odds', nl: 'odds' },
    '(tahmini)': { en: '(estimated)', nl: '(geschat)' },
    'Kupon oranı': { en: 'Coupon odds', nl: 'Couponodds' },
    '(tahmini — gerçek oran maç haftası gelir)': { en: '(estimated — real odds arrive in match week)', nl: '(geschat — echte odds komen in de speelweek)' },
    'Geçmiş öneriler': { en: 'Past suggestions', nl: 'Eerdere suggesties' },
    'Henüz sonuçlanan önerilen kupon yok; maçlar oynandıkça burada tuttu / tutmadı olarak listelenir.': { en: 'No settled suggested coupons yet; as matches are played they are listed here as won / lost.', nl: 'Nog geen afgehandelde gesuggereerde coupons; zodra wedstrijden gespeeld zijn verschijnen ze hier als gewonnen / verloren.' },
    '{n} kupondan {w} tuttu': { en: '{w} of {n} coupons won', nl: '{w} van {n} coupons gewonnen' },
    'Tutmadı': { en: 'Lost', nl: 'Verloren' },
    '(özel risk: en yakın standart profil)': { en: '(custom risk: nearest standard profile)', nl: '(aangepast risico: dichtstbijzijnde standaardprofiel)' },
    'Kupon önerisi': { en: 'Coupon suggestion', nl: 'Couponsuggestie' },
    'Kupon önerileri yükleniyor…': { en: 'Loading coupon suggestions…', nl: 'Couponsuggesties laden…' },
    'Kasanın risk seviyesine uygun kupon işaretli.': { en: 'The coupon matching your bankroll\'s risk level is marked.', nl: 'De coupon die past bij het risiconiveau van je bankroll is gemarkeerd.' },
    'Kasan özel risk seviyesinde; üç öneri de gösteriliyor.': { en: 'Your bankroll has a custom risk level; all three suggestions are shown.', nl: 'Je bankroll heeft een aangepast risiconiveau; alle drie suggesties worden getoond.' },
    'Önceki gün': { en: 'Previous day', nl: 'Vorige dag' },
    'Sonraki gün': { en: 'Next day', nl: 'Volgende dag' },
    'Düşük risk': { en: 'Low risk', nl: 'Laag risico' },
    'Orta risk': { en: 'Medium risk', nl: 'Gemiddeld risico' },
    'Yüksek risk': { en: 'High risk', nl: 'Hoog risico' },
    'Kasana uygun': { en: 'Fits your bankroll', nl: 'Past bij je bankroll' },
    '{n} maç · Çifte Şans ≥ {t}': { en: '{n} match(es) · Double chance ≥ {t}', nl: '{n} wedstrijd(en) · Dubbele kans ≥ {t}' },
    'Model: kuponun tutma olasılığı': { en: 'Model: chance the coupon wins', nl: 'Model: kans dat de coupon wint' },
    'Adil oran': { en: 'Fair odds', nl: 'Faire odds' },
    'Bu gün kurala uyan yeterli maç yok.': { en: 'Not enough matches fit this rule on this day.', nl: 'Op deze dag passen niet genoeg wedstrijden bij deze regel.' },
    'Önümüzdeki günlerde kurala uyan maç yok.': { en: 'No matches fit the rules in the coming days.', nl: 'De komende dagen passen geen wedstrijden bij de regels.' },
    'cs.hist': { tr: 'Geçmişte bu kural: <b>{n}</b> kupon, <b>{w}</b> tuttu · ort. piyasa oranı <b>{o}</b>', en: 'This rule in the past: <b>{n}</b> coupons, <b>{w}</b> won · avg. market odds <b>{o}</b>', nl: 'Deze regel in het verleden: <b>{n}</b> coupons, <b>{w}</b> gewonnen · gem. marktodds <b>{o}</b>' },
    'cs.note': { tr: 'Kurallar ve geçmiş sayılar, modelin maç öncesi olasılıklarıyla son sezonlarda gerçek piyasa oranlarına göre ölçüldü; her gün güncellenir. Tutma oranı yüksek olsa da oranlar düşük olduğundan bu kurallar uzun vadede piyasa oranlarıyla <b>kâr etmedi</b> ({roi}). Bu bir kazanç garantisi değil; Sanal Kasa simülasyonu içindir. Bahis şirketindeki gerçek oranı adil oranla karşılaştır.', en: 'Rules and past figures were measured with the model\'s pre-match probabilities against real market odds over recent seasons; updated daily. Although the hit rate is high, the odds are low, so in the long run these rules did <b>not make a profit</b> at market odds ({roi}). This is no guarantee of winnings; it is for the Virtual Bankroll simulation. Compare the bookmaker\'s real odds with the fair odds.', nl: 'Regels en historische cijfers zijn gemeten met de kansen van het model vóór de wedstrijd tegen echte marktodds over de afgelopen seizoenen; dagelijks bijgewerkt. De trefkans is hoog, maar de odds zijn laag, dus op lange termijn maakten deze regels bij marktodds <b>geen winst</b> ({roi}). Dit is geen garantie op winst; het is voor de Virtuele bankroll-simulatie. Vergelijk de echte odds van de bookmaker met de faire odds.' },
    'Model ne kadar güvenilir? (kalibrasyon)': { en: 'How reliable is the model? (calibration)', nl: 'Hoe betrouwbaar is het model? (kalibratie)' },
    'cal.note': { tr: 'Maçlar modelin verdiği olasılığa göre gruplandı; her nokta o gruptaki maçların <b>gerçekte</b> ne sıklıkla gerçekleştiğini gösterir. Noktalar kesikli köşegene ne kadar yakınsa model o kadar dürüst: "%90" dediğinde gerçekten ~%90 oluyor. İçi boş noktalar az maçlı gruplardır.', en: 'Matches are grouped by the probability the model gave; each dot shows how often those matches <b>actually</b> happened. The closer the dots are to the dashed diagonal, the more honest the model: when it says "90%", it really happens ~90% of the time. Hollow dots are groups with few matches.', nl: 'Wedstrijden zijn gegroepeerd op de kans die het model gaf; elke stip toont hoe vaak die wedstrijden <b>echt</b> uitkwamen. Hoe dichter de stippen bij de gestippelde diagonaal liggen, hoe eerlijker het model: als het "90%" zegt, gebeurt het echt ~90% van de tijd. Open stippen zijn groepen met weinig wedstrijden.' },
    'cal.hl': { tr: 'Vurgulu tahminlerde model ortalama <b>{p}</b> dedi, <b>{a}</b> gerçekleşti ({n} tahmin).', en: 'On highlighted picks the model said <b>{p}</b> on average; <b>{a}</b> happened ({n} picks).', nl: 'Bij gemarkeerde voorspellingen zei het model gemiddeld <b>{p}</b>; <b>{a}</b> kwam uit ({n} voorspellingen).' },
    'cal.gap': { tr: 'Ortalama sapma: <b>{g} puan</b>', en: 'Average deviation: <b>{g} points</b>', nl: 'Gemiddelde afwijking: <b>{g} punten</b>' },
    'Bu filtrede vurgulu tahmin yok.': { en: 'No highlighted picks for this filter.', nl: 'Geen gemarkeerde voorspellingen voor dit filter.' },
    'Kalibrasyon grafiği': { en: 'Calibration chart', nl: 'Kalibratiegrafiek' },
    'mükemmel kalibrasyon': { en: 'perfect calibration', nl: 'perfecte kalibratie' },
    'vurgu eşiği': { en: 'highlight threshold', nl: 'markeringsdrempel' },
    'Modelin verdiği olasılık (%)': { en: 'Probability given by the model (%)', nl: 'Kans volgens het model (%)' },
    'Gerçekleşme (%)': { en: 'Actually happened (%)', nl: 'Werkelijk uitgekomen (%)' },
    'Tablo olarak göster': { en: 'Show as table', nl: 'Als tabel tonen' },
    'Olasılık aralığı (%)': { en: 'Probability range (%)', nl: 'Kansbereik (%)' },
    'Fark (puan)': { en: 'Difference (points)', nl: 'Verschil (punten)' },
    'Model %{r} arası dedi': { en: 'Model said {r}%', nl: 'Model zei {r}%' },
    '{n} maç · ort. model {p} · gerçekleşen {a}': { en: '{n} matches · avg. model {p} · happened {a}', nl: '{n} wedstrijden · gem. model {p} · uitgekomen {a}' },
    'az maç — güvenilir değil': { en: 'few matches — not reliable', nl: 'weinig wedstrijden — niet betrouwbaar' },
    ...
    'isabet oranı': { en: 'hit rate', nl: 'trefpercentage' },
    ...
    "BETAVUS'u kullanmak için en az 18 yaşında olmalısın.": { en: 'You must be at least 18 to use BETAVUS.', nl: 'Je moet minstens 18 jaar oud zijn om BETAVUS te gebruiken.' },
    ...
    'Hesabımı sil': { en: 'Delete my account', nl: 'Mijn account verwijderen' },
    'Hesabını kalıcı olarak sil': { en: 'Permanently delete your account', nl: 'Je account definitief verwijderen' },
    'Hesabın, profilin ve hesabına kaydedilmiş tüm Sanal Kasa verilerin kalıcı olarak silinir. Bu işlem geri alınamaz.': { en: 'Your account, your profile and all Virtual Bankroll data saved to your account will be permanently deleted. This cannot be undone.', nl: 'Je account, je profiel en alle Virtuele bankroll-gegevens in je account worden definitief verwijderd. Dit kan niet ongedaan worden gemaakt.' },
    'Bu cihazdaki Sanal Kasa verilerini de sil': { en: 'Also delete the Virtual Bankroll data on this device', nl: 'Ook de Virtuele bankroll-gegevens op dit apparaat verwijderen' },
    'Onaylamak için kullanıcı adını yaz: {name}': { en: 'Type your username to confirm: {name}', nl: 'Typ je gebruikersnaam ter bevestiging: {name}' },
    'Hesabımı kalıcı olarak sil': { en: 'Permanently delete my account', nl: 'Mijn account definitief verwijderen' },
    'Siliniyor…': { en: 'Deleting…', nl: 'Verwijderen…' },
    'Hesap silme henüz etkinleştirilmedi. Lütfen daha sonra tekrar dene.': { en: 'Account deletion is not enabled yet. Please try again later.', nl: 'Account verwijderen is nog niet geactiveerd. Probeer het later opnieuw.' },
    'Hesap silinemedi: ': { en: 'Could not delete the account: ', nl: 'Account kon niet worden verwijderd: ' },
    'Hesabın silindi': { en: 'Your account has been deleted', nl: 'Je account is verwijderd' },
    'Hesabın ve tüm verilerin silindi. Bu cihazdaki Sanal Kasa verileri de temizlendi.': { en: 'Your account and all your data have been deleted. The Virtual Bankroll data on this device has been cleared too.', nl: 'Je account en al je gegevens zijn verwijderd. De Virtuele bankroll-gegevens op dit apparaat zijn ook gewist.' },
    'Hesabın ve buluttaki tüm verilerin silindi. Bu cihazdaki Sanal Kasa verileri yerinde duruyor.': { en: 'Your account and all your data in the cloud have been deleted. The Virtual Bankroll data on this device has been kept.', nl: 'Je account en al je gegevens in de cloud zijn verwijderd. De Virtuele bankroll-gegevens op dit apparaat zijn bewaard.' },
    'Vazgeç': { en: 'Cancel', nl: 'Annuleren' },
    ...
    'Toplam Başlangıç': { en: 'Total start', nl: 'Totale startbankroll' },
    'Toplam Kapanış': { en: 'Total close', nl: 'Totale slotbankroll' },
