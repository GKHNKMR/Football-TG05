...
(function (root) {
  ...
  add({
    ...
    'Kasan büyüdükçe bir kısmını kilitle. Kilitlediğin para bir daha riske girmez ama hedefine sayılır.': { en: 'As your bankroll grows, lock part of it. Money you lock is never at risk again, but it still counts towards your target.', nl: 'Zet een deel van je bankroll vast naarmate die groeit. Vastgezet geld loopt nooit meer risico, maar telt wel mee voor je doel.' },
    'Oyundaki': { en: 'In play', nl: 'In het spel' },
    'Kilitli': { en: 'Locked', nl: 'Vastgezet' },
    'Toplam': { en: 'Total', nl: 'Totaal' },
    '(hedefin {pct})': { en: '({pct} of target)', nl: '({pct} van doel)' },
    ...
    'Bugünkü kuponun {stake} · Rahat sınırın {limit}': { en: "Today's bet {stake} · Your comfort limit {limit}", nl: 'Inzet vandaag {stake} · Je comfortgrens {limit}' },
    '🔒 {amount} kilitle': { en: '🔒 Lock {amount}', nl: '🔒 {amount} vastzetten' },
    'riski de {risk} seviyesine düşür': { en: 'also lower risk to {risk}', nl: 'risico ook verlagen naar {risk}' },
    'Rahat sınır = seçtiğin tutar ({base}) + kilitli paran. Kilitli para güvende olduğu için sınır onunla birlikte büyür.': { en: 'Comfort limit = the amount you chose ({base}) + your locked money. Locked money is safe, so the limit grows with it.', nl: 'Comfortgrens = het bedrag dat je koos ({base}) + je vastgezette geld. Vastgezet geld is veilig, dus de grens groeit mee.' },
    'Sonra kuponun {stake} olur.': { en: 'Your bet then becomes {stake}.', nl: 'Je inzet wordt dan {stake}.' },
    'Sınırına yaklaşıyorsun.': { en: 'You are getting close to your limit.', nl: 'Je nadert je grens.' },
    'Rahatsın, planına devam et.': { en: "You're comfortable, stick to your plan.", nl: 'Je zit goed, ga door met je plan.' },
    ...
    'Sıradaki durak: kasa {bank} olunca {amount} kilitle': { en: 'Next stop: when your bankroll reaches {bank}, lock {amount}', nl: 'Volgende stop: als je bankroll {bank} is, zet {amount} vast' },
    'Hedefe kadar başka durak yok.': { en: 'No more stops before the target.', nl: 'Geen stops meer vóór het doel.' },
    ...
    'Hedefe giden yol': { en: 'Road to your target', nl: 'Weg naar je doel' },
    'Sen buradasın: {v}': { en: 'You are here: {v}', nl: 'Je bent hier: {v}' },
    '{day}. gün: {amount} kilitlendi': { en: 'Day {day}: {amount} locked', nl: 'Dag {day}: {amount} vastgezet' },
    'Bugün: {amount} kilitle': { en: 'Today: lock {amount}', nl: 'Vandaag: {amount} vastzetten' },
    'Kasa {bank} olunca {amount} kilitle': { en: 'At {bank}: lock {amount}', nl: 'Bij {bank}: {amount} vastzetten' },
    ...
    'Rahat Sınır ({sym})': { en: 'Comfort limit ({sym})', nl: 'Comfortgrens ({sym})' },
    'Tek kupona en fazla ne kadar koymak seni rahatsız etmez? Boş bırakırsan başlangıç kasası kullanılır.': { en: "What is the most you can put on a single bet without feeling uneasy? If you leave it empty, the starting bankroll is used.", nl: 'Hoeveel kun je maximaal op één weddenschap zetten zonder je ongemakkelijk te voelen? Laat je het leeg, dan wordt de startbankroll gebruikt.' },
    'Tek kupona en fazla ne kadar koymak seni rahatsız etmez? Boş bırakırsan başlangıç kasası kullanılır. (Sonra "Rahat Sınır" alanından değiştirebilirsin.)': { en: 'What is the most you can put on a single bet without feeling uneasy? If you leave it empty, the starting bankroll is used. (You can change it later in the "Comfort limit" field.)', nl: 'Hoeveel kun je maximaal op één weddenschap zetten zonder je ongemakkelijk te voelen? Laat je het leeg, dan wordt de startbankroll gebruikt. (Je kunt dit later wijzigen in het veld "Comfortgrens".)' },
    'Geçerli bir tutar girin veya boş bırakın.': { en: 'Enter a valid amount or leave it empty.', nl: 'Voer een geldig bedrag in of laat het leeg.' },
