...
(function (root) {
  ...
  add({
    ...
    'GERÇEK': { en: 'ACTUAL', nl: 'WERKELIJK' },
    'HEDEF': { en: 'TARGET', nl: 'DOEL' },
    'Gün': { en: 'Day', nl: 'Dag' },
    'Günlük Değişim ({sym})': { en: 'Daily change ({sym})', nl: 'Dagelijkse wijziging ({sym})' },
    'Günlük Büyüme (%)': { en: 'Daily growth (%)', nl: 'Dagelijkse groei (%)' },
    'Günlük Kazanç ({sym})': { en: 'Daily gain ({sym})', nl: 'Dagelijkse winst ({sym})' },
    'Hedefe Ulaşma (%)': { en: 'Target reached (%)', nl: 'Doel bereikt (%)' },
